...
namespace Kw.Windows.Forms.FastColored
{
    public class SyntaxHighlighter : IDisposable
    {
        internal static Brush Lipstick = new SolidBrush(Color.FromArgb(255, 0, 128));
        ...
        public readonly Style VioletStyle = new TextStyle(Brushes.BlueViolet, null, FontStyle.Bold);
        public readonly Style LipstickStyle = new TextStyle(Lipstick, null, FontStyle.Regular);
        ...
        public void InitStyleSchema(Language lang)
        {
            ...
            {
                case Language.CSharp:
                    StringStyle = LipstickStyle;
                    CommentStyle = GreenStyle;
                    NumberStyle = MagentaStyle;
                    AttributeStyle = GreenStyle;
                    ClassNameStyle = VioletStyle;
