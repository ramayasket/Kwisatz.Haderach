    ...
    public static class MemberInfoExtensions {
        ...
        internal static (OneOf<MethodInfo, string> method, object?[] args) GetInputs(this MemberInfo mi) {
            ...
            if (mi is FieldInfo || mi is EventInfo) {
                ...
                if (flags.Outside(defaultLookups)) { parameters.Add(typeof(BindingFlags), flags); }
                ...
                if (mi is PropertyInfo) {
                    if (otherMemberCount > 0 && flags.Outside(defaultLookups)) {
                    ...
                    if (flags.Outside(defaultLookups)) {
