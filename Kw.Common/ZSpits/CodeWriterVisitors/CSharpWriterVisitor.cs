...
using static Kw.Common.ZSpitz.CSharpMultilineBlockTypes;
using static Kw.Common.ZSpitz.CSharpBlockMetadata;
...
namespace Kw.Common.ZSpitz
{
    public class CSharpWriterVisitor : CodeWriterVisitor {
        ...
        protected override void WriteParameterDeclaration(ParameterExpression prm) {
            ...
            Write($"{prm.Type.FriendlyName(language)} {Functions.GetVariableName(prm, ref IDs)}");
        }
        ...
        protected override void WriteBlock(BlockExpression expr, object? metadata) {
            ...
            if (blockType.Inside(CSharpMultilineBlockTypes.Block, CSharpMultilineBlockTypes.Return)) {
        ...
        static int getPrecedence(Expression node, Type? parentType = null) {
            ...
            return nodeType switch
            {
                ...
                var x when x.Inside(Unbox, ExpressionType.Convert, ConvertChecked) && !renderConversion => -1,
        ...
        protected override void Parens(OneOf<Expression, ExpressionType> arg, string path, Expression childNode) {
            ...
            var leftAssociative = parentNodeType.Outside(rightAssociatives);
                    ...
                    switch (childNode) {
                        case BinaryExpression or ConditionalExpression:
                            writeParens =
                                ...
                                (!leftAssociative && path.Inside("Left", "Test"));
                            break;
