...
namespace Kw.Common.ZSpitz
{
    public class FactoryMethodsWriterVisitor : BuiltinsWriterVisitor {
        ...
        protected override void WriteBinary(BinaryExpression expr) {
            ...
            if (expr.NodeType.Inside(ExpressionType.Power, ExpressionType.PowerAssign) && expr.Method == powerMethod) {
        ...
        protected override void WriteUnary(UnaryExpression expr) {
            ...
            if (
                (expr.NodeType.Inside(ExpressionType.Convert, ExpressionType.ConvertChecked, ExpressionType.TypeAs, ExpressionType.Unbox)) ||
